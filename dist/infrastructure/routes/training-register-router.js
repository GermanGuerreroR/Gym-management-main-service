...
exports.trainingRegisterActivity = void 0;
const express_1 = __importDefault(require("express"));
const training_activity_controller_1 = require("../../application/controllers/training-activity-controller");
const trainingRegisterActivity = () => {
    const router = express_1.default.Router();
    const trainingCtrl = new training_activity_controller_1.TrainingActivityController();
    /**
 * @swagger
 * /trainings:
 *   post:
...
exports.trainingRegisterActivity = trainingRegisterActivity;
